...
\definecolor{highlightcolour}{rgb}{0.22,0.45,0.70}% light blue
...
\newcommand{\payeeaddresslinethree}[1]{\renewcommand{\payeeaddresslinethree}{#1}}
...
\newcommand{\senderaddresslinethree}[1]{\renewcommand{\senderaddresslinethree}{#1}}
...
\newcommand{\thankyounote}[1]{\renewcommand{\thankyounote}{#1}}
...
\newcommand{\invoicedtotable}{
	{
		...
		\begin{tabular}{p{0.26\textwidth} p{0.33\textwidth} p{0.33\textwidth}}
			...
			\multirow{3}{*}{{\color{highlightcolour} \Huge INVOICE}} & \textbf{Recipient} & \textbf{Sender}\\
			 & \payeename & \sendername \\ 
			 & \payeeaddresslineone & \senderaddresslineone \\
			 \multirow{3}{*}{{\color{highlightcolour} \Huge \#\invoiceref }} & \payeeaddresslinetwo & \senderaddresslinetwo \\
			 & \payeeaddresslinethree & \senderaddresslinethree \\
			 & \payeecontactlineone & \sendercontactlineone \\
			 & \payeecontactlinetwo & \sendercontactlinetwo\\			
...
{
	\begin{tabular}{p{0.6\textwidth} R{0.1\textwidth} R{0.08\textwidth} R{0.12\textwidth}}
		\textbf{ITEM} & \textbf{HOURS} & \textbf{RATE} & \textbf{SUBTOTAL} \\
...
%		\begin{tabular}{p{0.68\textwidth} p{0.22\textwidth}}
		\begin{tabular}{>{\arraybackslash}m{0.625\textwidth} p{0.05\textwidth} R{0.25\textwidth}}
			\arrayrulecolor{rulecolour}\toprule[0.5pt] % Horizontal line at the top of the table
			\thankyounote & & {\hfill{\color{highlightcolour}\Huge THANKS}}\\
			\arrayrulecolor{rulecolour}\bottomrule[0.5pt] % Horizontal line at the bottom of the table
		\end{tabular}
	}
}
